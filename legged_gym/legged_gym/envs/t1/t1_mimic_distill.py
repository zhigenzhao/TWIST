...
class T1MimicDistill(HumanoidMimic):
    """
    T1 Mimic environment for whole-body motion tracking.
    T1 has 24 links and 23 DOF (revolute joints).
    """
    ...
    def _reset_ref_motion(self, env_ids, motion_ids=None):
        """Reset reference motion for given environments."""
        n = len(env_ids)
        ...
        # T1: No complex body mapping needed (unlike G1 with finger joints)
        # If body_pos doesn't match, may need to add mapping function later
    ...
    def _update_ref_motion(self):
        ...
        # T1: No complex body mapping needed
    ...
    def compute_observations(self):
        ...
        # disable ankle dof velocity observations (same indices as G1)
        ankle_idx = [4, 5, 10, 11]
...
############################################################################################################
    ...
    def _reward_ankle_dof_acc(self):
        # Ankle indices are the same as G1: [4, 5, 10, 11]
